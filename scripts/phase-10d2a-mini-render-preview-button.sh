...
cat > apps/booth-ui/src/components/admin/TemplateRenderPreviewPanel.tsx <<'TSX'
...
if "TemplateRenderPreviewPanel" not in text:
    text = text.replace(
...
if "<TemplateRenderPreviewPanel />" not in text:
    if marker not in text:
        raise SystemExit("Could not find TemplateAssetSummaryPanel block.")
