...
cat > apps/booth-ui/src/render/final-render-types.ts <<'TS'
...
cat > apps/booth-ui/src/render/final-renderer.ts <<'TS'
...
cat > apps/booth-ui/src/render/index.ts <<'TS'
export * from './final-render-types';
export * from './final-renderer';
TS

echo "10D1Z mini done."
