...
echo "========================================"
echo " Phase 10D1F - Basic Layout Slot Editor"
echo "========================================"

mkdir -p apps/booth-ui/src/components/admin

cat > apps/booth-ui/src/components/admin/LayoutSlotEditorPanel.tsx <<'TSX'
...
if "LayoutSlotEditorPanel" not in text:
...
marker = """      <div className="mt-5 rounded-3xl border border-emerald-100 bg-emerald-50 p-4">"""
...
if "<LayoutSlotEditorPanel />" not in text:
    if marker not in text:
        raise SystemExit("Could not find Guide Controls marker.")
...
echo ""
echo "Created:"
echo "- apps/booth-ui/src/components/admin/LayoutSlotEditorPanel.tsx"
echo ""
echo "Patched:"
echo "- apps/booth-ui/src/components/admin/LayoutAdminPanel.tsx"
echo ""
echo "Phase 10D1F completed."
