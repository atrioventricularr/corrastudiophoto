...
echo "========================================"
echo " Phase 8D2A - DOKU QRIS Check Status"
echo "========================================"

mkdir -p supabase/functions/check-doku-qris-status

cat > supabase/functions/check-doku-qris-status/index.ts <<'TS'
...
echo ""
echo "Created:"
echo "- supabase/functions/check-doku-qris-status/index.ts"
echo ""
echo "Phase 8D2A completed."
